...
const CustomerBookingPage: React.FC = () => {
    ...
    useEffect(() => {
        const savedLocation = (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).getItem('jt_customer_location');
        const selectedAddrId = (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).getItem('jt_selected_address_id');
        const savedAddresses = (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).getItem('jt_saved_addresses');
