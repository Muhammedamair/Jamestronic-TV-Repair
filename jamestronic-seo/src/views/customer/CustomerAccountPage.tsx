...
const CustomerAccountPage: React.FC = () => {
    ...
    const handleVerifyOtp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (token) {
                ...
                (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).setItem('jamestronic_customer_mobile', mobile);
                setIsLoggedIn(true);
                setView('PROFILE');
    ...
    const handleLogout = async () => {
        ...
        (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).removeItem('jamestronic_customer_mobile');
        (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).removeItem('jamestronic_customer_name');
        setProfile(null);
        setIsLoggedIn(false);
        setMobile('');
        setOtp('');
