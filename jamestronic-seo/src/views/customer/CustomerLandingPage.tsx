...
const CustomerLandingPage: React.FC<CustomerLandingPageProps> = ({ initialServiceUpdates = [], initialHeroBanners = [] }) => {
    ...
    const [heroBanners, setHeroBanners] = useState<PromotionalBanner[]>(initialHeroBanners);
    ...
    const [serviceUpdates, setServiceUpdates] = useState<ServiceUpdate[]>(initialServiceUpdates);
    useEffect(() => {
    ...
    useEffect(() => {
        const saved = (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).getItem('jt_customer_location');
        if (saved) {
            try {
        ...
        const addresses = (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).getItem('jt_saved_addresses');
        if (addresses) {
            try { setSavedAddresses(JSON.parse(addresses)); } catch { /* ignore */ }
        }
        const selId = (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).getItem('jt_selected_address_id');
        if (selId) setSelectedAddressId(selId);
    }, []);

    // Persist saved addresses
    const persistAddresses = (addrs: SavedAddress[], selId?: string | null) => {
        (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).setItem('jt_saved_addresses', JSON.stringify(addrs));
        setSavedAddresses(addrs);
        if (selId !== undefined) {
            if (selId) (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).setItem('jt_selected_address_id', selId);
            else (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).removeItem('jt_selected_address_id');
    ...
    const detectLocation = useCallback(async () => {
        ...
        navigator.geolocation.getCurrentPosition(
            async (position) => {
                ...
                (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).setItem('jt_customer_location', JSON.stringify({ area: result.area, city: result.city }));
                setSelectedAddressId(null);
                (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).removeItem('jt_selected_address_id');
                setLocating(false);
    ...
    const selectAddress = (addr: SavedAddress) => {
        ...
        (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).setItem('jt_customer_location', JSON.stringify({ area: addr.area, city: addr.fullAddress }));
    ...
    const handleAddAddress = () => {
        ...
        (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).setItem('jt_customer_location', JSON.stringify({ area: newAddr.area, city: newAddr.fullAddress }));
    ...
    const selectSearchResult = (result: { area: string; fullAddress: string }) => {
        ...
        (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).setItem('jt_customer_location', JSON.stringify({ area: result.area, city: result.fullAddress }));
        setSelectedAddressId(null);
        (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{}, clear:()=>{} }).removeItem('jt_selected_address_id');
        setSearchQuery('');
        setSearchResults([]);
